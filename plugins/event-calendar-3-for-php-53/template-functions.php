...
function ec3_get_calendar_nav($date,$num_months)
{
  ...
  echo "\t<td id='prev'><a id='ec3_prev' href='" . $prev->month_link() . "'"
     . "><img src='../images/teach-calendar-lf-btn.jpg' alt='Previous' /></a></td>\n";
  ...
  echo "\t<td id='title'><a href='" . $date->month_link() . "' title='" . $title . "'>"
    . $date->month_name() . " " . $date->year_num . "</a></td>\n";
  ...
  if($calendar_entries)
  {
    ...
    foreach($calendar_entries as $entry)
    {
      ...
      if((!$current_month || $current_month!=$data['MONTH']) && $template_month)
      {
        ...
        if($current_month)
            echo "</ul></li>\n";
    	echo "<li class='ec3_list ec3_list_month'><img alt='Event' src='http://seekingmichigan.org/images/teach-home-icon-calendar.jpg'><span class='subheader'>".ec3_format_str($template_month,$data)."</span><ul>";
      ...
      if((!$current_date || $current_date!=$data['DATE']) && $template_day)
      {
        if($current_date)
            echo "</ul></li>\n";
    	echo "<li class='ec3_list ec3_list_day'><img alt='Event' src='http://seekingmichigan.org/images/teach-home-icon-calendar.jpg'><span class='subheader'>".ec3_format_str($template_day,$data)."</span><ul>";
